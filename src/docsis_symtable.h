...
{ 1426,   "M256MspsUpstreamTransmitChannel",   26,     144,    (encode_uchar),          (decode_uchar),          0,           0             }, /* TLV 5.26 MULPIv3.0-I24 Aneex C.1.3.1.26 */
...
{ 1428,   "CMInterfaceMaskCMIMSubtype",        4,      202,    (encode_hexstr),         (decode_hexstr),         0,           0             }, /* TLV 22.43.5.4 L2VPN-I13 Annex B.3.4 */
...
{ 751,    "UpstreamAggregateServiceFlowReference", 36, 80,     (encode_ushort),         (decode_ushort),         1,           65535         }, /* TLV 24.36 MULPIv3.0-I24 Annex C.2.2.5.10 */
...
{ 1434,   "LatencyHistogramEncodings",         6,      753,    (encode_ushort_list),    (decode_ushort_list),    1,           15            }, /* TLV 24.40.6 MULPIv3.1-I25 Annex C.2.2.9.15.6 */
...
{ 1429,   "MulticastRulePriority",             1,      997,    (encode_uchar),          (decode_uchar),          0,           255           }, /* TLV 24.43.10.2.1 MULPIv3.0-I24 Annex C.1.1.18.1.9.2.1 */
{ 1430,   "AuthorizationAction",               2,      997,    (encode_uchar),          (decode_uchar),          0,           1             }, /* TLV 24.43.10.2.2 MULPIv3.0-I24 Annex C.1.1.18.1.9.2.2 */
...
{ 1435,   "GuaranteedGrantInterval",           44,     80,     (encode_ushort),         (decode_ushort),         0,           0             }, /* TLV 24.44 MULPIv3.1-I25 Annex C.2.2.10.13 */
{ 1436,   "GuaranteedGrantRate",               45,     80,     (encode_uint),           (decode_uint),           0,           0             }, /* TLV 24.45 MULPIv3.1-I25 Annex C.2.2.10.14 */
{ 1437,   "GuaranteedRequestInterval",         46,     80,     (encode_ushort),         (decode_ushort),         0,           0             }, /* TLV 24.46 MULPIv3.1-I25 Annex C.2.2.10.15 */
{ 1438,   "AbsoluteQueueDepthRequestEnable",   48,     80,     (encode_uchar),          (decode_uchar),          0,           1             }, /* TLV 24.48 MULPIv3.1-I25 Annex C.2.2.10.17 */
{ 1439,   "PGSActivityDetectionDisable",       49,     80,     (encode_uchar),          (decode_uchar),          0,           1             }, /* TLV 24.49 MULPIv3.1-I25 Annex C.2.2.10.16 */
...
{ 1280,   "DownstreamAggregateServiceFlowReference", 36, 102,  (encode_ushort),         (decode_ushort),         1,           65535         }, /* TLV 25.36 MULPIv3.0-I24 Annex C.2.2.5.10 */
...
{ 1445,   "LatencyHistogramEncodings",         6,      1282,   (encode_ushort_list),    (decode_ushort_list),    1,           15            }, /* TLV 24.40.6 MULPIv3.1-I25 Annex C.2.2.9.15.6 */
...
{ 1427,   "MulticastMACAddress",               42,     0,      (encode_ether),          (decode_ether),          0,           0             }, /* TLV 42 MULPIv3.0-I24 Annex C.1.1.23 */
...
{ 519,    "ASFQoSProfileName",                 4,      517,    (encode_strzero),        (decode_strzero),        2,           16            }, /* TLV 70.4 MULPIv3.1-I25 Annex C.2.2.9.12 */
{ 1446,   "TrafficPriority",                   7,      517,    (encode_uchar),          (decode_uchar),          0,           7             }, /* TLV 70.7 MULPIv3.1-I25 Annex C.2.2.9.1 */
{ 1447,   "MaxRateSustained",                  8,      517,    (encode_uint),           (decode_uint),           0,           0             }, /* TLV 70.8 MULPIv3.1-I25 Annex C.2.2.9.2.1 */
{ 1448,   "MaxTrafficBurst",                   9,      517,    (encode_uint),           (decode_uint),           0,           0             }, /* TLV 70.9 MULPIv3.1-I25 Annex C.2.2.9.3 */
{ 1449,   "MinReservedRate",                   10,     517,    (encode_uint),           (decode_uint),           0,           0             }, /* TLV 70.10 MULPIv3.1-I25 Annex C.2.2.9.4 */
{ 1450,   "MinResPacketSize",                  11,     517,    (encode_ushort),         (decode_ushort),         0,           65535         }, /* TLV 70.11 MULPIv3.1-I25 Annex C.2.2.9.5 */
{ 1451,   "UpstreamPeakTrafficRate",           27,     517,    (encode_uint),           (decode_uint),           0,           0             }, /* TLV 70.27 MULPIv3.1-I25 Annex C.2.2.9.10.1 */
{ 520,    "UpstreamMESPReference",             37,     517,    (encode_ushort),         (decode_ushort),         1,           65535         }, /* TLV 70.37 MULPIv3.0-I24 Annex C.2.2.5.11 */
{ 1452,   "ServiceFlowMatchingCriteria",       38,     517,    (encode_nothing),        (decode_aggregate),      0,           0             }, /* TLV 70.38 MULPIv3.1-I25 Annex C.2.2.9.13 */
{ 1453,   "MatchingbyApplicationId",           1,      1452,   (encode_uint),           (decode_uint),           0,           1             }, /* TLV 70.38.1 MULPIv3.1-I25 Annex C.2.2.9.13.1 */
{ 1454,   "MatchingbyServiceClassName",        2,      1452,   (encode_strzero),        (decode_strzero),        2,           16            }, /* TLV 70.38.2 MULPIv3.1-I25 Annex C.2.2.9.13.2 */
{ 1455,   "MatchingbyTrafficPriorityRange",    3,      1452,   (encode_char_list),      (decode_char_list),      2,           2             }, /* TLV 70.38.3 MULPIv3.1-I25 Annex C.2.2.9.13.3 */
{ 1456,   "DataRateUnitSetting",               41,     517,    (encode_uchar),          (decode_uchar),          0,           3             }, /* TLV 70.41 MULPIv3.1-I25 Annex C.2.2.9.16 */
{ 1457,   "LowLatencyAggregateSFEncodings",    42,     517,    (encode_nothing),        (decode_aggregate),      0,           0             }, /* TLV 70.42 MULPIv3.1-I25 Annex C.2.2.9.17 */
{ 1458,   "LowLatencyServiceFlowReference",    1,      1457,   (encode_ushort),         (decode_ushort),         1,           65535         }, /* TLV 70.42.1 MULPIv3.1-I25 Annex C.2.2.9.17.1 */
{ 1459,   "ClassicSFSCN",                      3,      1457,   (encode_strzero),        (decode_strzero),        2,           16            }, /* TLV 70.42.3 MULPIv3.1-I25 Annex C.2.2.9.17.3 */
{ 1460,   "LowLatencySFSCN",                   4,      1457,   (encode_strzero),        (decode_strzero),        2,           16            }, /* TLV 70.42.4 MULPIv3.1-I25 Annex C.2.2.9.17.4 */
{ 1461,   "AQMCouplingFactor",                 5,      1457,   (encode_uchar),          (decode_uchar),          0,           0             }, /* TLV 70.42.5 MULPIv3.1-I25 Annex C.2.2.9.17.5 */
{ 1462,   "SchedulingWeight",                  6,      1457,   (encode_uchar),          (decode_uchar),          1,           255           }, /* TLV 70.42.6 MULPIv3.1-I25 Annex C.2.2.9.17.6 */
{ 1463,   "QueueProtectionEnable",             7,      1457,   (encode_uchar),          (decode_uchar),          0,           1             }, /* TLV 70.42.7 MULPIv3.1-I25 Annex C.2.2.9.17.7 */
{ 1464,   "QPLatencyThreshold",                8,      1457,   (encode_ushort),         (decode_ushort),         0,           0             }, /* TLV 70.42.8 MULPIv3.1-I25 Annex C.2.2.9.17.8 */
{ 1465,   "QPQueuingScoreThreshold",           9,      1457,   (encode_ushort),         (decode_ushort),         0,           0             }, /* TLV 70.42.9 MULPIv3.1-I25 Annex C.2.2.9.17.9 */
{ 1466,   "QPDrainRateExponent",               10,     1457,   (encode_uchar),          (decode_uchar),          0,           0             }, /* TLV 70.42.10 MULPIv3.1-I25 Annex C.2.2.9.17.10 */
...
{ 523,    "ASFQoSProfileName",                 4,      521,    (encode_strzero),        (decode_strzero),        2,           16            }, /* TLV 71.4 MULPIv3.1-I25 Annex C.2.2.9.12 */
{ 1467,   "TrafficPriority",                   7,      521,    (encode_uchar),          (decode_uchar),          0,           7             }, /* TLV 71.7 MULPIv3.1-I25 Annex C.2.2.9.1 */
{ 1468,   "MaxRateSustained",                  8,      521,    (encode_uint),           (decode_uint),           0,           0             }, /* TLV 71.8 MULPIv3.1-I25 Annex C.2.2.9.2.2 */
{ 1469,   "MaxTrafficBurst",                   9,      521,    (encode_uint),           (decode_uint),           0,           0             }, /* TLV 71.9 MULPIv3.1-I25 Annex C.2.2.9.3 */
{ 1470,   "MinReservedRate",                   10,     521,    (encode_uint),           (decode_uint),           0,           0             }, /* TLV 71.10 MULPIv3.1-I25 Annex C.2.2.9.4 */
{ 1471,   "MinResPacketSize",                  11,     521,    (encode_ushort),         (decode_ushort),         0,           65535         }, /* TLV 71.11 MULPIv3.1-I25 Annex C.2.2.9.5 */
{ 1472,   "DownstreamPeakTrafficRate",         27,     521,    (encode_uint),           (decode_uint),           0,           0             }, /* TLV 71.27 MULPIv3.1-I25 Annex C.2.2.9.10.1 */
{ 524,    "DownstreamMESPReference",           37,     521,    (encode_ushort),         (decode_ushort),         1,           65535         }, /* TLV 71.37 MULPIv3.0-I24 Annex C.2.2.5.11 */
{ 1473,   "ServiceFlowMatchingCriteria",       38,     521,    (encode_nothing),        (decode_aggregate),      0,           0             }, /* TLV 71.38 MULPIv3.1-I25 Annex C.2.2.9.13 */
{ 1474,   "MatchingbyApplicationId",           1,      1473,   (encode_uint),           (decode_uint),           0,           1             }, /* TLV 71.38.1 MULPIv3.1-I25 Annex C.2.2.9.13.1 */
{ 1475,   "MatchingbyServiceClassName",        2,      1473,   (encode_strzero),        (decode_strzero),        2,           16            }, /* TLV 71.38.2 MULPIv3.1-I25 Annex C.2.2.9.13.2 */
{ 1476,   "MatchingbyTrafficPriorityRange",    3,      1473,   (encode_char_list),      (decode_char_list),      2,           2             }, /* TLV 71.38.3 MULPIv3.1-I25 Annex C.2.2.9.13.34 */
{ 1477,   "DataRateUnitSetting",               41,     521,    (encode_uchar),          (decode_uchar),          0,           3             }, /* TLV 71.41 MULPIv3.1-I25 Annex C.2.2.9.16 */
{ 1478,   "LowLatencyAggregateSFEncodings",    42,     521,    (encode_nothing),        (decode_aggregate),      0,           0             }, /* TLV 71.42 MULPIv3.1-I25 Annex C.2.2.9.17 */
{ 1479,   "LowLatencyServiceFlowReference",    1,      1478,   (encode_ushort),         (decode_ushort),         1,           65535         }, /* TLV 71.42.1 MULPIv3.1-I25 Annex C.2.2.9.17.1 */
{ 1480,   "ClassicSFSCN",                      3,      1478,   (encode_strzero),        (decode_strzero),        2,           16            }, /* TLV 71.42.3 MULPIv3.1-I25 Annex C.2.2.9.17.3 */
{ 1481,   "LowLatencySFSCN",                   4,      1478,   (encode_strzero),        (decode_strzero),        2,           16            }, /* TLV 71.42.4 MULPIv3.1-I25 Annex C.2.2.9.17.4 */
{ 1482,   "AQMCouplingFactor",                 5,      1478,   (encode_uchar),          (decode_uchar),          0,           0             }, /* TLV 71.42.5 MULPIv3.1-I25 Annex C.2.2.9.17.5 */
{ 1483,   "SchedulingWeight",                  6,      1478,   (encode_uchar),          (decode_uchar),          1,           255           }, /* TLV 71.42.6 MULPIv3.1-I25 Annex C.2.2.9.17.6 */
{ 1484,   "QueueProtectionEnable",             7,      1478,   (encode_uchar),          (decode_uchar),          0,           1             }, /* TLV 71.42.7 MULPIv3.1-I25 Annex C.2.2.9.17.7 */
{ 1485,   "QPLatencyThreshold",                8,      1478,   (encode_ushort),         (decode_ushort),         0,           0             }, /* TLV 71.42.8 MULPIv3.1-I25 Annex C.2.2.9.17.8 */
{ 1486,   "QPQueuingScoreThreshold",           9,      1478,   (encode_ushort),         (decode_ushort),         0,           0             }, /* TLV 71.42.9 MULPIv3.1-I25 Annex C.2.2.9.17.9 */
{ 1487,   "QPDrainRateExponent",               10,     1478,   (encode_uchar),          (decode_uchar),          0,           0             }, /* TLV 71.42.10 MULPIv3.1-I25 Annex C.2.2.9.17.10 */
...
{ 479,    "EnergyManagement1x1ModeIndicator",  75,     0,      (encode_uchar),          (decode_uchar),          0,           2             }, /* TLV 75 MULPIv3.0-I24 Annex C.1.4.4 */
...
{ 1500,   "QoSFrameworkforDOCSISEncodings",    88,     0,      (encode_nothing),        (decode_aggregate),      0,           0             }, /* TLV 88 MULPIv3.1-I25 Annex C.1.7 */
{ 1501,   "LowLatencyDisable",                 91,     0,      (encode_uchar),          (decode_uchar),          0,           2             }, /* TLV 91 MULPIv3.1-I25 Annex C.1.1.32 */
{ 1502,   "DistributedHQoSEnable",             92,     0,      (encode_uchar),          (decode_uchar),          0,           2             }, /* TLV 92 MULPIv3.1-I25 Annex C.1.1.33 */
{ 1503,   "UpstreamEHQoSASF",                  93,     0,      (encode_nothing),        (decode_aggregate),      0,           0             }, /* TLV 93 MULPIv3.1-I25 Annex C.2.2.5 */
{ 1504,   "ServiceFlowReference",              1,      1503,   (encode_ushort),         (decode_ushort),         1,           65535         }, /* TLV 93.1 MULPIv3.1-I25 Annex C.2.2.7.1 */
{ 1505,   "TrafficPriority",                   7,      1503,   (encode_uchar),          (decode_uchar),          0,           7             }, /* TLV 93.7 MULPIv3.1-I25 Annex C.2.2.9.1 */
{ 1506,   "MaxSustainedRate",                  8,      1503,   (encode_uint),           (decode_uint),           0,           0             }, /* TLV 93.8 MULPIv3.1-I25 Annex C.2.2.9.2.1 */
{ 1507,   "MaxTrafficBurst",                   9,      1503,   (encode_uint),           (decode_uint),           0,           0             }, /* TLV 93.9 MULPIv3.1-I25 Annex C.2.2.9.3 */
{ 1508,   "MinReservedRate",                   10,     1503,   (encode_uint),           (decode_uint),           0,           0             }, /* TLV 93.10 MULPIv3.1-I25 Annex C.2.2.9.4 */
{ 1509,   "MinResPacketSize",                  11,     1503,   (encode_ushort),         (decode_ushort),         0,           65535         }, /* TLV 93.11 MULPIv3.1-I25 Annex C.2.2.9.5 */
{ 1510,   "EnhancedHQoSIntraASFSchedulingEncoding", 47, 1503,  (encode_nothing),        (decode_aggregate),      0,           0             }, /* TLV 93.47 MULPIv3.1-I25 Annex C.2.2.9.18 */
{ 1511,   "ConstituentSFReference",            1,      1510,   (encode_ushort),         (decode_ushort),         1,           65535         }, /* TLV 93.47.1 MULPIv3.1-I25 Annex C.2.2.9.18.1 */
{ 1512,   "ConstituentSFSCN",                  3,      1510,   (encode_strzero),        (decode_strzero),        2,           16            }, /* TLV 93.47.3 MULPIv3.1-I25 Annex C.2.2.9.18.3 */
{ 1513,   "ConstituentSFPriority",             4,      1510,   (encode_uchar),          (decode_uchar),          0,           7             }, /* TLV 93.47.4 MULPIv3.1-I25 Annex C.2.2.9.18.4 */
{ 1514,   "ConstituentSFWeight",               5,      1510,   (encode_uchar),          (decode_uchar),          0,           0             }, /* TLV 93.47.5 MULPIv3.1-I25 Annex C.2.2.9.18.5 */
{ 1515,   "UpstreamEHQoSASF",                  94,     0,      (encode_nothing),        (decode_aggregate),      0,           0             }, /* TLV 94 MULPIv3.1-I25 Annex C.2.2.6 */
{ 1516,   "ServiceFlowReference",              1,      1515,   (encode_ushort),         (decode_ushort),         1,           65535         }, /* TLV 94.1 MULPIv3.1-I25 Annex C.2.2.7.1 */
{ 1517,   "TrafficPriority",                   7,      1515,   (encode_uchar),          (decode_uchar),          0,           7             }, /* TLV 94.7 MULPIv3.1-I25 Annex C.2.2.9.1 */
{ 1518,   "MaxSustainedRate",                  8,      1515,   (encode_uint),           (decode_uint),           0,           0             }, /* TLV 94.8 MULPIv3.1-I25 Annex C.2.2.9.2.2 */
{ 1519,   "MaxTrafficBurst",                   9,      1515,   (encode_uint),           (decode_uint),           0,           0             }, /* TLV 94.9 MULPIv3.1-I25 Annex C.2.2.9.3 */
{ 1520,   "MinReservedRate",                   10,     1515,   (encode_uint),           (decode_uint),           0,           0             }, /* TLV 94.10 MULPIv3.1-I25 Annex C.2.2.9.4 */
{ 1521,   "MinResPacketSize",                  11,     1515,   (encode_ushort),         (decode_ushort),         0,           65535         }, /* TLV 94.11 MULPIv3.1-I25 Annex C.2.2.9.5 */
{ 1522,   "EnhancedHQoSIntraASFSchedulingEncoding", 47, 1515,  (encode_nothing),        (decode_aggregate),      0,           0             }, /* TLV 94.47 MULPIv3.1-I25 Annex C.2.2.9.18 */
{ 1523,   "ConstituentSFReference",            1,      1522,   (encode_ushort),         (decode_ushort),         1,           65535         }, /* TLV 94.47.1 MULPIv3.1-I25 Annex C.2.2.9.18.1 */
{ 1524,   "ConstituentSFSCN",                  3,      1522,   (encode_strzero),        (decode_strzero),        2,           16            }, /* TLV 94.47.3 MULPIv3.1-I25 Annex C.2.2.9.18.3 */
{ 1525,   "ConstituentSFPriority",             4,      1522,   (encode_uchar),          (decode_uchar),          0,           7             }, /* TLV 94.47.4 MULPIv3.1-I25 Annex C.2.2.9.18.4 */
{ 1526,   "ConstituentSFWeight",               5,      1522,   (encode_uchar),          (decode_uchar),          0,           0             }, /* TLV 94.47.5 MULPIv3.1-I25 Annex C.2.2.9.18.5 */
{ 1527,   "AdvancedDiplexerBandEdge",          96,     0,      (encode_nothing),        (decode_aggregate),      0,           0             }, /* TLV 96 MULPIv4.0-I07 Annex C.1.2.24 */
{ 1528,   "AdvDiplexerUpstreamUpperBandEdge",  1,      1527,   (encode_ushort),         (decode_ushort),         0,           0             }, /* TLV 96.1 MULPIv4.0-I07 Annex C.1.2.24.1 */
...
{ 156,    "InitializationModeOverride",        3,      175,    (encode_uchar),          (decode_uchar),          0,           1             }, /* TLV 202.3 eRouter-I12 Annex B.4.4 */
...
{ 476,    "TopologyModeEncoding",              42,     175,    (encode_uchar),          (decode_uchar),          1,           2             }, /* TLV 202.42 eRouter-I12 Annex B.4.9 */
