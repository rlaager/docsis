...
{ 120, "SAMapWaitTimeout",     8,   18,  (get_uint),      (decode_uint),        1,        10         },
{ 121, "SAMapMaxRetries",      9,   18,  (get_uint),      (decode_uint),        0,        10         },

/* ManufacturerCVC */

{ 122, "MfgCVCData",           32,  0,   (get_hexstr),    (decode_hexstr),      0,        0          },
{ 123, "VendorSpecific",       43,  0,   (get_nothing),   (decode_aggregate),   0,        0          },
{ 124, "VendorIdentifier",     8,   123, (get_hexstr),    (decode_hexstr),      3,        3          },
{ 125, "MtaConfigDelimiter",   254, 0,   (get_uchar),     (decode_uchar),      	1,        255        },
