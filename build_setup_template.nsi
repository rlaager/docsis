...
; Get NSIS hat http://nsis.sourceforge.net

!include "MUI.nsh"

!define MUI_PRODUCT "docsis"
!define MUI_VERSION "0.9.0"
...
LicenseData "@@buildroot@@\License.txt"
...
; Documentation
  ...
  File "@@buildroot@@\doc\index.html"
  File "@@buildroot@@\doc\config-format.html"
  File "@@buildroot@@\doc\config-settings.html"
SectionEnd
...
Section "Example files" SEC02
  ...
  File "@@buildroot@@\examples\docsis20_no_snmp.cfg"
  File "@@buildroot@@\examples\docsis20.cfg"
  File "@@buildroot@@\examples\docsis1.1_stress_test.cfg"
  File "@@buildroot@@\examples\docsis1.1_simple.cfg"
  File "@@buildroot@@\examples\docsis1.1_oss_v3coex.cfg"
  File "@@buildroot@@\examples\docsis1.1_classifiers2.cfg"
  File "@@buildroot@@\examples\docsis1.1_classifiers.cfg"
  File "@@buildroot@@\examples\docsis1.0_filters2_oidtext.cfg"
  File "@@buildroot@@\examples\docsis1.0_filters2_oidnum.cfg"
  File "@@buildroot@@\examples\docsis1.0_filters_oidtext.cfg"
  File "@@buildroot@@\examples\docsis1.0_filters_oidnum.cfg"
  File "@@buildroot@@\examples\docsis1.0_filters_NmAccess.cfg"
  File "@@buildroot@@\examples\docsis1.0_example.cfg"
  File "@@buildroot@@\examples\docsis1.0_basic_upgrade.cfg"
  File "@@buildroot@@\examples\docsis1.0_basic_bpi.cfg"
  File "@@buildroot@@\examples\docsis1.0_basic.cfg"
  File "@@buildroot@@\examples\docsis1.0_2class_rfc2669.cfg"
  File "@@buildroot@@\examples\docsis1.0_2class_non-rfc2669.cfg"
SectionEnd

Section "SNMP MIBs" SEC03
  SetOutPath "$INSTDIR\snmp\mibs"
  File "@@netsnmproot@@\UDP-MIB.txt"
  File "@@netsnmproot@@\UCD-SNMP-MIB.txt"
  File "@@netsnmproot@@\UCD-IPFWACC-MIB.txt"
  File "@@netsnmproot@@\UCD-DLMOD-MIB.txt"
  File "@@netsnmproot@@\UCD-DISKIO-MIB.txt"
  File "@@netsnmproot@@\UCD-DEMO-MIB.txt"
  File "@@netsnmproot@@\TCP-MIB.txt"
  File "@@netsnmproot@@\SNMP-VIEW-BASED-ACM-MIB.txt"
  File "@@netsnmproot@@\SNMPv2-TM.txt"
  File "@@netsnmproot@@\SNMPv2-TC.txt"
  File "@@netsnmproot@@\SNMPv2-SMI.txt"
  File "@@netsnmproot@@\SNMPv2-MIB.txt"
  File "@@netsnmproot@@\SNMPv2-CONF.txt"
  File "@@netsnmproot@@\SNMP-USER-BASED-SM-MIB.txt"
  File "@@netsnmproot@@\SNMP-TARGET-MIB.txt"
  File "@@netsnmproot@@\SNMP-PROXY-MIB.txt"
  File "@@netsnmproot@@\SNMP-NOTIFICATION-MIB.txt"
  File "@@netsnmproot@@\SNMP-MPD-MIB.txt"
  File "@@netsnmproot@@\SNMP-FRAMEWORK-MIB.txt"
  File "@@netsnmproot@@\SNMP-COMMUNITY-MIB.txt"
  File "@@netsnmproot@@\SMUX-MIB.txt"
  File "@@netsnmproot@@\RMON-MIB.txt"
  File "@@netsnmproot@@\RFC-1215.txt"
  File "@@netsnmproot@@\RFC1213-MIB.txt"
  File "@@netsnmproot@@\RFC1155-SMI.txt"
  File "@@netsnmproot@@\NOTIFICATION-LOG-MIB.txt"
  File "@@netsnmproot@@\NET-SNMP-TC.txt"
  File "@@netsnmproot@@\NET-SNMP-MIB.txt"
  File "@@netsnmproot@@\NET-SNMP-EXAMPLES-MIB.txt"
  File "@@netsnmproot@@\NET-SNMP-AGENT-MIB.txt"
  File "@@netsnmproot@@\IPV6-UDP-MIB.txt"
  File "@@netsnmproot@@\IPV6-TCP-MIB.txt"
  File "@@netsnmproot@@\IPV6-TC.txt"
  File "@@netsnmproot@@\IPV6-MIB.txt"
  File "@@netsnmproot@@\IPV6-ICMP-MIB.txt"
  File "@@netsnmproot@@\IP-MIB.txt"
  File "@@netsnmproot@@\IP-FORWARD-MIB.txt"
  File "@@netsnmproot@@\INET-ADDRESS-MIB.txt"
  File "@@netsnmproot@@\IF-MIB.txt"
  File "@@netsnmproot@@\IF-INVERTED-STACK-MIB.txt"
  File "@@netsnmproot@@\IANA-LANGUAGE-MIB.txt"
  File "@@netsnmproot@@\IANAifType-MIB.txt"
  File "@@netsnmproot@@\IANA-ADDRESS-FAMILY-NUMBERS-MIB.txt"
  File "@@netsnmproot@@\HOST-RESOURCES-TYPES.txt"
  File "@@netsnmproot@@\HOST-RESOURCES-MIB.txt"
  File "@@netsnmproot@@\HCNUM-TC.txt"
  File "@@netsnmproot@@\EtherLike-MIB.txt"
  File "@@netsnmproot@@\AGENTX-MIB.txt"
  File "@@netsnmproot@@\DISMAN-SCRIPT-MIB.txt"
  File "@@netsnmproot@@\DISMAN-SCHEDULE-MIB.txt"
  File "@@buildroot@@\mibs\IGMP-STD-MIB.mib"
  File "@@buildroot@@\mibs\DOCS-SUBMGT-MIB.mib"
  File "@@buildroot@@\mibs\DOCS-QOS-MIB.mib"
  File "@@buildroot@@\mibs\DOCS-IF-MIB.mib"
  File "@@buildroot@@\mibs\DOCS-IF-EXT-MIB.mib"
  File "@@buildroot@@\mibs\DOCS-CABLE-DEVICE-TRAP-MIB.mib"
  File "@@buildroot@@\mibs\DOCS-CABLE-DEVICE-MIB.mib"
  File "@@buildroot@@\mibs\DOCS-BPI-MIB.mib"
  File "@@buildroot@@\mibs\DOCS-BPI2-MIB.mib"
  File "@@buildroot@@\mibs\CLAB-DEF-MIB.txt"
  File "@@buildroot@@\mibs\PKTC-SIG-MIB.mib"
  File "@@buildroot@@\mibs\PKTC-MTA-MIB.mib"
  File "@@buildroot@@\mibs\PKTC-EVENT-MIB.mib"
...
!insertmacro MUI_FUNCTIONS_DESCRIPTION_BEGIN
  ...
  !insertmacro MUI_DESCRIPTION_TEXT ${SEC02} "These are example configuration file (in text format). These are just examples, some of them are not useable in a real network. Make sure you understand what's in there before using them."
...
Section Uninstall
  ...
  Delete "$INSTDIR\examples\testkey.key"
  ...
  Delete "$INSTDIR\snmp\mibs\PKTC-SIG-MIB.mib"
  Delete "$INSTDIR\snmp\mibs\PKTC-MTA-MIB.mib"
  Delete "$INSTDIR\snmp\mibs\PKTC-EVENT-MIB.mib"
  ...
  Delete "$INSTDIR\snmp\mibs\IGMP-STD-MIB.mib"
  ...
  Delete "$INSTDIR\snmp\mibs\DOCS-SUBMGT-MIB.mib"
  Delete "$INSTDIR\snmp\mibs\DOCS-QOS-MIB.mib"
  Delete "$INSTDIR\snmp\mibs\DOCS-IF-MIB.mib"
  Delete "$INSTDIR\snmp\mibs\DOCS-IF-EXT-MIB.mib"
  Delete "$INSTDIR\snmp\mibs\DOCS-CABLE-DEVICE-TRAP-MIB.mib"
  Delete "$INSTDIR\snmp\mibs\DOCS-CABLE-DEVICE-MIB.mib"
  Delete "$INSTDIR\snmp\mibs\DOCS-BPI-MIB.mib"
  Delete "$INSTDIR\snmp\mibs\DOCS-BPI2-MIB.mib"
  Delete "$INSTDIR\snmp\mibs\DISMAN-SCRIPT-MIB.txt"
  Delete "$INSTDIR\snmp\mibs\DISMAN-SCHEDULE-MIB.txt"
  Delete "$INSTDIR\snmp\mibs\CLAB-DEF-MIB.txt"
